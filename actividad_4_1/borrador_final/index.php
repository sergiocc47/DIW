...
<html lang="es">
	...
	<body>
		...
		<?php
			...
			// $oCKeditor1->replace('fichero_personal');	// al no pasar la instancia como parámetro se carga la configuración por defecto
			...
			// $oCKeditor2->replace('fichero_formativo');
			...
			// $oCKeditor3->replace('fichero_laboral');
		?>
