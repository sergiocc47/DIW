...
<html lang="es">
	...
	<!-- TODO: estilo en CSS -->
	<body style="padding:20px;font-family:'Barlow',sans-serif;">	<!-- TODO: quitar padding a resto de elementos -->
		<div id="cabecera" style="overflow: auto;padding:20px;">
			<div id="anim" width="100%" style="float:left;">
				<!--<img src="./video/Surfing Rat Fink.jpg"/>-->
				<img width="83px" src="./img/logo.png"/>
				<!--<img src="./video/film-roll_83px.png"/>-->	<!-- FAIL: desplaza título ligeramente a la dcha. -->
			</div>
			<div id="titulo" style="overflow: auto;text-align: center">
				<h1 style="float:left;width:99%;padding:0 auto;">
				<?php
		...
		<div id="formulario" style="border: 3px solid #c83636;padding:20px;display: flex;justify-content: center;">
		...
		<div style="width: 45%;padding-left:20px;float: right;">
